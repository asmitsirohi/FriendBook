<nav class="navbar navbar-expand-lg navbar-dark bg-dark sticky-top">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <div class="row">
            ...
            <button class="btn" data-toggle="modal" data-target="#friendRequest">
                <i class="fas fa-user-friends text-light" id="icons" data-toggle="tooltip" data-placement="bottom"
...
<?php include("friendRequestModal.php");?>
<?php include("chatBoxModal.php");?>